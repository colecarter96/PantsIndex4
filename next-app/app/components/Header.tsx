...
const Header: React.FC<HeaderProps> = () => (
  <header className="fixed top-0 left-0 right-0 z-50">
    <div className=" hidden md:flex justify-center bg-red-600 text-white">
        <Link href="/waitlist">We are currently developing! Click here to stay up to date or hit us with sugggestions!</Link>
    </div>

    <div className="flex md:hidden justify-center bg-red-600 text-white">
        <Link href="/waitlist">Click here to stay up to date or hit us with sugggestions!</Link>
    </div>
    <div className="fixed shadow top-6 left-0 right-0 flex justify-between lg:justify-center items-center pt-6 pb-3 px-5 bg-white  z-50">
